            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <section class="text-gray-600 body-font relative">
                        <form action="{{ route('rental.update', $equipmentItem->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('post')
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input type="text" id="manufacturer" name="manufacturer" value="{{ old('manufacturer', $equipmentItem->manufacturer) }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-pink-500 focus:bg-white focus:ring-2 focus:ring-pink-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input type="text" id="location_stored" name="location_stored" value="{{ old('location_stored', $equipmentItem->location_stored) }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-pink-500 focus:bg-white focus:ring-2 focus:ring-pink-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input type="date" id="purchase_date" name="purchase_date" value="{{ old('purchase_date', $equipmentItem->purchase_date) }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-pink-500 focus:bg-white focus:ring-2 focus:ring-pink-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input type="number" id="quantity" name="quantity" value="{{ old('quantity', $equipmentItem->quantity) }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-pink-500 focus:bg-white focus:ring-2 focus:ring-pink-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input type="number" id="max_rental_days" name="max_rental_days" value="{{ old('max_rental_days', $equipmentItem->max_rental_days) }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-pink-500 focus:bg-white focus:ring-2 focus:ring-pink-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input type="number" step="0.01" id="price" name="price" value="{{ old('price', $equipmentItem->price) }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-pink-500 focus:bg-white focus:ring-2 focus:ring-pink-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                <x-input-error :messages="$errors->get('price')" class="mt-2" />
                                            </div>
                                        </div>

                                        <div class="p-2 w-full">
                                            <label class="leading-7 text-sm text-gray-600 dark:text-gray-200">{{ __('rental.current-images') }}</label>
                                            <div class="flex flex-wrap gap-4">
                                                @foreach($equipmentItem->images as $image)
                                                    <div class="relative">
                                                        <img src="{{ str_contains($image->image_path, 'seed_images') ? asset($image->image_path) : asset('storage/' . $image->image_path) }}" alt="Equipment Image" class="w-24 h-24 object-cover rounded">
                                                        <label class="block text-sm text-center dark:text-gray-200">
                                                            <input type="checkbox" name="remove_images[]" value="{{ $image->id }}"> {{ __('rental.remove-image') }}
                                                        </label>
                                                    </div>
                                                @endforeach
                                            </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <label for="images" class="leading-7 text-sm text-gray-600 dark:text-gray-200">{{ __('rental.new-images') }}</label>
