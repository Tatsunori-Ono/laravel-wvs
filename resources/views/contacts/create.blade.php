                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input type="text" id="name" name="name" value="{{ old('name', Auth::user()->name ?? '') }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-pink-500 focus:bg-white focus:ring-2 focus:ring-pink-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input type="email" id="email" name="email" value="{{ old('email', Auth::user()->email ?? '') }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-pink-500 focus:bg-white focus:ring-2 focus:ring-pink-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input type="radio" name="non_warwick_student" value="0" style="margin-right: .5rem;" {{ old('non_warwick_student', Auth::user()->warwick_id ? '0' : '') == '0' ? 'checked' : '' }}><span class="dark:text-gray-200">{{__('contact.warwick-student')}}</span><br>
                                                <input type="radio" name="non_warwick_student" value="1" style="margin-right: .5rem;" {{ old('non_warwick_student', Auth::user()->warwick_id ? '' : '1') == '1' ? 'checked' : '' }}><span class="dark:text-gray-200">{{__('contact.non-warwick-student')}}</span>
